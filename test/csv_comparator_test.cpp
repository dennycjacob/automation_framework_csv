...
// Utility function to normalize file paths across Linux and Windows systems
// this will replace "\\" in Windows system to "/"
...
void testCSVComparator() {
    ...
    cout << "Enter the numbers of the two files to compare (e.g., 1 2) or enter 0 to exit: ";
    cin >> file1Index >> file2Index;

    if (file1Index < 1 || file1Index > csvFiles.size() || file2Index < 1 || file2Index > csvFiles.size() || file1Index
        == file2Index) {
